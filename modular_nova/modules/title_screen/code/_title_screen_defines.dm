...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_nova/modules/title_screen/icons/mint_title_screen.png' // MINT EDIT
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_nova/modules/title_screen/icons/loading_screen.gif' // MINT EDIT
